...
| | County Board District | Your county-legislature seat, picked by county: Cook Commissioner district (live officeholder join, office pin), Will or DuPage County Board district (weekly-scraped rosters + DuPage's countywide Chair), Lake County Board district (member + contact carried on the county's own GIS), Kane County Board district (member names on the county's own GIS), Kendall County Board district (the 5 members incl. the Chairman with phone/email, weekly-scraped from the county's own directory), or a McHenry County Board district (the district's 2 members plus the countywide-elected Board Chairman with phone/email, weekly-scraped from the county's own directory) |
...
| | Fire Protection District | Suburban fire *protection* (taxing) district, picked by county (Cook / Will / DuPage / Lake / Kane / McHenry / Kendall) — trustees in Will, office contact in Lake, chief + contact in Kane, name-only in Cook, DuPage, McHenry, and Kendall |
...
| | Park District | Park district, picked by county (Cook / Will / DuPage / Lake / Kane / Kendall — McHenry publishes no district boundaries) — a Chicago click resolves the Chicago Park District; commissioners in Will, office contact in Lake, board president + contact in Kane, name-only in Cook, DuPage, and Kendall |
| | Library District | Which separate library taxing body serves the point, picked by county — Cook distinguishes independent Public Library Districts from municipal Library Funds (a Chicago click resolves the City of Chicago Library Fund); trustees in Will, name-only in DuPage, McHenry, and Kendall (whose tiling includes the Joliet and Yorkville municipal city-library funds), office contact in Lake, board president + contact in Kane |
| | Voting Precinct | County voting precinct (a sub-selection of Township), picked by county (suburban Cook / Will / DuPage / Lake / Kane / McHenry / Kendall), with the containing County Board district and the county clerk's election lookup — Kendall's card also shows the county's own polling-place assignment. In Chicago this layer stays hidden: city precincts are the Ward Precinct layer |
...
| [mchenrycountyil.gov](https://www.mchenrycountyil.gov/departments/county-board/meet-your-county-board-members) (scraped weekly by CI) | McHenry County Board member roster incl. the countywide Chairman (`data/app/mchenry-county-board-members.json`) |
