...
| | County Board District | Your county-legislature seat, picked by county: Cook Commissioner district (live officeholder join, office pin), Will or DuPage County Board district (weekly-scraped rosters + DuPage's countywide Chair), Lake County Board district (member + contact carried on the county's own GIS), Kane County Board district (member with party, office phone, email + the countywide-elected Board Chair, weekly-scraped from the county's own directory list), Kendall County Board district (the 5 members incl. the Chairman with phone/email), or a McHenry County Board district (the district's 2 members plus the countywide-elected Board Chairman with phone/email) — Kendall's and McHenry's rosters verified against each county's own member directory |
