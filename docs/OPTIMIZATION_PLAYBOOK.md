...
| 27 | CPD scraper blocked by Cloudflare managed challenge (403) — fetch district pages via Playwright/Chromium (CI already installs it), keep `requests` as fallback; safety net already prevents bad data — R11 | Medium | Medium | Pipeline |
